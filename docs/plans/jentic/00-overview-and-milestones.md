...
| M7 | Shadow and rollout | M6 | seven days and 10,000 eligible assessments reviewed |
...
- Benign false blocks are at most 0.1%; benign flags are at most 1%.
...
- Core handles queue saturation, deadlines, artifact failure, and graceful shutdown as
  specified.
- Seven shadow days and 10,000 eligible assessments complete before general enforcement.
